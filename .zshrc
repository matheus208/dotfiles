...
plugins=(git autojump zsh-fzf-history-search)
...
# __conda_setup="$('/Users/matheus.nash/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
# if [ $? -eq 0 ]; then
#     eval "$__conda_setup"
# else
#     if [ -f "/Users/matheus.nash/miniforge3/etc/profile.d/conda.sh" ]; then
#         . "/Users/matheus.nash/miniforge3/etc/profile.d/conda.sh"
#     else
#         export PATH="/Users/matheus.nash/miniforge3/bin:$PATH"
#     fi
# fi
# unset __conda_setup
# <<< conda initialize <<<
...
controlinho() {
  #The UUID of the controlinho to search
  id=$1
  rg "$id" $NU_HOME/controlinho --heading | head -n1 | sed 's/\.json$/.sql/' | xargs cat;
}
